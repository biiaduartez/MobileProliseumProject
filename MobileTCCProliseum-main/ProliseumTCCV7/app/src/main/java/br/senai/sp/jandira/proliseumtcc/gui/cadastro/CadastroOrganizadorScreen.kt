...
@Composable
fun CadastroOrganizadorScreen(sharedViewModelTokenEId: SharedViewTokenEId, sharedViewModelPerfilOrganizador: SharedViewModelPerfilOrganizador, onNavigate: (String) -> Unit) {
